...
class B2TrackerHit : public G4VHit
{
  public:
    ...
    void SetParticlePDGEncoding (G4int pdg) {fParticlePDGEncoding = pdg;}
    ...
    G4int GetParticlePDGEncoding() const {return fParticlePDGEncoding;};
